...
to gather empirical evidence while also testing and maintaining theoretical foundations of LRH
as presented in \citet{park2023LRH}. Furthermore, Large Language Models (LLMs) are susceptible 
...
\begin{enumerate}
    ...
    \item Apply \citet{park2023LRH} causal separabillity framework to safety and utility.
